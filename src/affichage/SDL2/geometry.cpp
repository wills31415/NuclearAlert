...
sdl2::rectangle::rectangle( const std::array<int,2>& position,
                            const std::array<int,2>& dimension, const sdl2::color& col,
                            bool fill)
...
// =================================================================================================
sdl2::line::line( const std::array<int,2>& beg_pos,
                  const std::array<int,2>& end_pos, const color& col )
